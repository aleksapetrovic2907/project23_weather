...
async function WeatherToHTML(location) {
    await fetch(`https://api.openweathermap.org/data/2.5/weather?q=${location}&appid=4585c4c190d1f33203d6cd396638aa4e`, { mode: 'cors' })
